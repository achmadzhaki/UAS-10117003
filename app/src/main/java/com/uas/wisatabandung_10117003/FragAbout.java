...
public class FragAbout extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        about.setText("APLIKASI WISATA ADALAH APLIKASI YANG MEMBERITAHUAKN NAMA SERTA LOKASI WISATA DI BANDUNG RAYA, YAITU KOTA BANDUNG, KAB.BANDUNG, KAB. BANDUNG BARAT");
        return view;
    }
}